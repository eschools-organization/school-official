...
const Admin: React.FC = () => {
    ...
    const [view, setView] = useState(() => {
        ...
        return 'main';
    }); // 'main', 'studentOptions', 'studentList', 'addStudentForm', 'teacherList', 'addTeacherForm', 'teacherOptions', 'addClassForm', 'addSubjectForm', 'editClass', 'classHistoryGrades', 'classHistoryParallels', 'classHistoryTable', 'manageCalendars', 'detailedGradeHistory', 'subjectList'
